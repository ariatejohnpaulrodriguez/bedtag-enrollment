        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                <?php
                    $principal_info = mysqli_query($conn, "SELECT *, CONCAT(student_fname, ' ', student_lname) AS fullname FROM tbl_Students");
                ...
                <tr>
                  ...
                  <td>
                    <a type="button" href="edit.student.php?student_id=<?php echo $row['student_id']; ?>" class="btn btn-primary btn-sm m-1">
                      Edit
                    </a>
